...
public class PrintJobPrintingInfo implements PrintJobAttribute{
    ...
    private String mPullResult; //SmartSDK V2.12
    ...
    PrintJobPrintingInfo(GetJobStatusResponseBody.PrintingInfo info) {
        ...
        this.mPullResult = info.getPullResult();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if(!isEqual(this.mPullResult,otherInfo.getPullResult())) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (this.mPullResult == null ? 0 : this.mPullResult.hashCode());
        return result;
    }
    ...
    public String toString() {
        if(this.cache == null) {
            ...
            sb.append("fileReadCompleted:").append(this.mPrintedCount).append(",");
            sb.append("pullResult:").append(this.mPullResult);
            sb.append("}");
