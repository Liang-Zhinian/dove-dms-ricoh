...
public class SearchLdapEntryResponseBody extends Element implements ResponseBody {
	...
	private static final String KEY_OVER_UPPER_LIMIT	= "overUpperLimit";// SmartSDK V2.12
	 ...
	 */
	public Boolean getOverUpperLimit() {
		return getBooleanValue(KEY_OVER_UPPER_LIMIT);
	}
