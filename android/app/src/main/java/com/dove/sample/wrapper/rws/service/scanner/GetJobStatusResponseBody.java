...
public class GetJobStatusResponseBody extends Element implements ResponseBody {
	...
	private static final String KEY_PRINTING_INFO		= "printingInfo";// SmartSDK V2.12
	...
	public static class ScanningInfo extends Element {
		...
		private static final String KEY_VALID_PAGE_COUNT	    = "validPageCount"; // SmartSDK V2.12
		 ...
		 * @since SmartSDK V2.12
		 */
		public Integer getValidPageCount() {
			return getNumberValue(KEY_VALID_PAGE_COUNT);
		}
	...
	public static class FilingInfo extends Element {
		...
		private static final String KEY_DIVIDED_FILED_COUNT		    = "dividedFiledCount"; // SmartSDK V2.12
		...
		/*
		 * dividedFiledCount (Number)
		 * @since SmartSDK V2.12
		 */
		public Integer getDividedFiledCount() {
		    return getNumberValue(KEY_DIVIDED_FILED_COUNT);
		}
	...
	public static class SendingInfo extends Element {
		...
		private static final String KEY_ERRORED_DESTINATION_COUNT   = "erroredDestinationCount"; // SmartSDK V2.12
		...
		/*
		 * erroredDestinationCount (Number)
		 * @since SmartSDK V2.12
		 */
		public Integer getErroredDestinationCount() {
			return getNumberValue(KEY_ERRORED_DESTINATION_COUNT);
		}
