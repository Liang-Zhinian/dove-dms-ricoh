...
public class GetDeviceInfoResponseBody extends Element implements ResponseBody {
    ...
    public static class Plotter extends Element {
        ...
        private static final String KEY_PAPER_TRANSPORT_DIRECTION = "paperTransportDirection";  // SmartSDK V2.12
        ...
        /*
         * paperTransportDirection (String)
         * @since SmartSDK V2.12
         */
        public String getPaperTransportDirection() {
            return getStringValue(KEY_PAPER_TRANSPORT_DIRECTION);
        }
        ...
        public static class FeedTrayInfo extends Element {
            ...
            public static class ConnectedFeedTrayConfigInfo extends Element {
                ...
                private static final String KEY_PAPER_SIZE_SENSE = "paperSizeSense"; // SmartSDK V2.12 
                ...
                /*
                 * paperSizeSense (Boolean)
                 * @since SmartSDK V2.12
                 */
                public Boolean getPaperSizeSense() {
                    return getBooleanValue(KEY_PAPER_SIZE_SENSE);
                }
