...
public class GetCopyStatusResponseBody extends Element implements ResponseBody  {
	...
	private static final String KEY_TEXT_STAMP_FIRST_NUMBER   = "textStampFirstNumber";  // SmartSDK V2.12
	...
	/*
	 * textStampFirstNumber (String)
	 * @since SmartSDK V2.12
	 */
	public String getTextStampFirstNumber(){
		return getStringValue(KEY_TEXT_STAMP_FIRST_NUMBER);
	}
