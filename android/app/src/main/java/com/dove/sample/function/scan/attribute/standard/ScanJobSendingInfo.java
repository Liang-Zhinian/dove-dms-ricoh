...
public final class ScanJobSendingInfo implements ScanJobAttribute {
	...
	private final int erroredDestinationCount; //SmartSDK V2.12
	...
	ScanJobSendingInfo(GetJobStatusResponseBody.SendingInfo info) {
		...
		erroredDestinationCount = Conversions.getIntValue(info.getErroredDestinationCount(), 0);
	 ...
	 */
	public int getErroredDestinationCount(){
		return erroredDestinationCount;
	}
	...
	public boolean equals(Object obj) {
		...
		if (erroredDestinationCount != other.erroredDestinationCount){
			return false;
		}
	...
	public int hashCode() {
		...
		result = 31 * result + erroredDestinationCount;
	...
	public String toString() {
		if (cache == null) {
			...
			sb.append("erroredDestinationCount:").append(erroredDestinationCount).append(", ");
