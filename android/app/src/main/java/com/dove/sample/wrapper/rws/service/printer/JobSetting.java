...
public class JobSetting extends WritableElement {
	...
	private static final String KEY_PAPER_SIZE_CUSTOM_HORIZONTAL 	 = "paperSizeCustomHorizontal"; // SmartSDK V2.12
	private static final String KEY_PAPER_SIZE_CUSTOM_VERTICAL		 = "paperSizeCustomVertical"; // Smart  SDK V2.12
	...
	private static final String KEY_FOLD                    = "fold";        // SmartSDK v2.30
    ...
    public void setPaperSizeCustomHorizontal(String value) {
    	setStringValue(KEY_PAPER_SIZE_CUSTOM_HORIZONTAL,value);
    }
    public String removePaperSizeCustomHorizontal() {
    	return removeStringValue(KEY_PAPER_SIZE_CUSTOM_HORIZONTAL);
    }
    /*
    ...
    public String getPaperSizeCustomVertical() {
    	return getStringValue(KEY_PAPER_SIZE_CUSTOM_VERTICAL);
    }
    public void setPaperSizeCustomVertical(String value) {
    	setStringValue(KEY_PAPER_SIZE_CUSTOM_VERTICAL,value);
    }
    public String removePaperSizeCustomVertical() {
    	return removeStringValue(KEY_PAPER_SIZE_CUSTOM_VERTICAL);
    }
	...
	public String getFold() {
		return getStringValue(KEY_FOLD);
	}
	public void setFold(String value) {
		setStringValue(KEY_FOLD, value);
	}
	public String removeFold() {
		return removeStringValue(KEY_FOLD);
	}
