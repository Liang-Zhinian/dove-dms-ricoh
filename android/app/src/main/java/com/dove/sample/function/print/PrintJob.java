 ...
 *  All rights reserved.
 */
package com.dove.sample.function.print;
...
import com.dove.sample.function.print.event.PrintJobEvent;
import com.dove.sample.function.print.event.PrintJobListener;
import com.dove.sample.function.print.impl.job.JobListener;
import com.dove.sample.function.print.impl.job.PrintJobMessageDispatcher;
...
public class PrintJob {
    ...
    private void notifyJobListeners(PrintJobAttributeSet attributes) {
        ...
        if(listeners.length > 0) {
            ...
            PrintJobState jobState = (PrintJobState)attributes.get(PrintJobState.class);
            if(jobState != null) {
