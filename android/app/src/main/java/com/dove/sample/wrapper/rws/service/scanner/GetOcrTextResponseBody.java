...
public class GetOcrTextResponseBody  extends Element implements ResponseBody {
    ...
    private static final String KEY_TITLE_AUTO_FILE_NAMED       = "titleAutoFileNamed"; // SmartSDK V2.12
    ...
    /*
     * titleAutoFileNamed (String)
     * @Since SmartSDk V2.12
     */
    public String getTitleAutoFileNamed() {
    	return getStringValue(KEY_TITLE_AUTO_FILE_NAMED);
    }
