...
public final class ScanJobFilingInfo implements ScanJobAttribute {
	...
	private final int dividedFiledCount; //SmartSDK V2.12
	...
	ScanJobFilingInfo(GetJobStatusResponseBody.FilingInfo info) {
		...
		dividedFiledCount = Conversions.getIntValue(info.getDividedFiledCount(), 0);
	 ...
	 */
	public int getDividedFiledCount(){
		return dividedFiledCount;
	}
	...
	public boolean equals(Object obj) {
		...
		if (dividedFiledCount != other.dividedFiledCount){
			return false;
		}
	...
	public int hashCode() {
		...
		result = 31 * result + dividedFiledCount;
	...
	public String toString() {
		if (cache == null) {
			...
			sb.append("dividedFiledCount:").append(dividedFiledCount).append(", ");
