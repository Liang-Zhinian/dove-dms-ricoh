...
public class Capability extends CapabilityElement {
	...
	private static final String KEY_PAPER_SIZE_CUSTOM_HORIZONTAL_RANGE    = "paperSizeCustomHorizontalRange"; // SmartSDK V2.12
	private static final String KEY_PAPER_SIZE_CUSTOM_VERTICAL_RANGE      = "paperSizeCustomVerticalRange";   // SmartSDK V2.12
	...
	private static final String KEY_FOLD_LIST                       = "foldList";      // SmartSDK v2.30
	...
	/*
	 * paperSizeCustomHorizontalRange (Range)
	 * @Since SmartSDK V2.12
	 */
	public RangeElement getPaperSizeCustomHorizontalRange() {
		return getRangeValue(KEY_PAPER_SIZE_CUSTOM_HORIZONTAL_RANGE);
	}
	
	/*
	 * paperSizeCustomVerticalRange (Range)
	 * @Since SmartSDK V2.12
	 */
	public RangeElement getPaperSizeCustomVerticalRange() {
		return getRangeValue(KEY_PAPER_SIZE_CUSTOM_VERTICAL_RANGE);
	}
	...
	public List<String> getFoldList() {
		return getArrayValue(KEY_FOLD_LIST);
	}
