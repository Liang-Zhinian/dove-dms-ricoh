 ...
 *   - Preview screen
 */
public class SimpleScanStateMachine {
    ...
    public enum State {
         ...
         */
        protected void actShowPleaseWait(final SimpleScanStateMachine sm, final Object prm) {
         ...
         */
        protected void actClosePleaseWait(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
         ...
         */
        protected void actShowBootFailedDialog(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
         ...
         */
        protected void actShowScanningDialog(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
         ...
         */
        protected void actCloseScanningDialog(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
         ...
         */
        protected void actUpdateScanningDialog(final SimpleScanStateMachine sm, final Object prm) {
            if(prm instanceof ScanJobAttributeSet) {
                sm.mHandler.post(new Runnable() {
                    @Override
                    public void run() {
         ...
         */
        protected void actWaitForNextOriginal(final SimpleScanStateMachine sm, final Object prm) {
         ...
         */
        protected void actCloseWaitForNextOriginal(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
         ...
         */
        protected void actShowPreview(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
                    sm.showPreview();
         ...
         */
        protected void actClosePreview(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
                    sm.closePreview();
         ...
         */
        protected void actShowJobStoppedDialog(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
         ...
         */
        protected void actCloseJobStoppedDialog(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
         ...
         */
        protected void actShowToastMessage(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
         ...
         */
        protected void actInitJobSetting(final SimpleScanStateMachine sm, final Object prm) {
            sm.mHandler.post(new Runnable() {
                @Override
                public void run() {
    ...
    public void procScanEvent(final ScanEvent event, final Object prm) {
        ...
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                State newState = mState.getNextState(SimpleScanStateMachine.this, event, prm);
                if (newState != null) {
                    Log.i(Const.TAG, PREFIX + "#evtp :" + event + " state:" + mState + " > " + newState);
                    mState.exit(SimpleScanStateMachine.this, prm);
                    mState = newState;
                    mState.entry(SimpleScanStateMachine.this, prm);
                }
            }
        });
    }
...
//            requestAttributes.add(jobMode);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (!result) {
                SimpleScanStateMachine.this.procScanEvent(ScanEvent.CHANGE_JOB_STATE_CANCELED);
            }
        }
